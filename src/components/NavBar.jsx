...
const NavBar = () => {
  ...
  const content = <>
    <div className='md:hidden block absolute top-16 w-full shadow-lg left-0'>
      <ul className="text-sm backdrop-blur-3xl font-semibold text-left px-[3.5rem] ease-in-out duration-500">
        <li className='my-3 py-3 hover:bg-[#ffffff14] hover:rounded item-center text-lg'><nav><NavLink to="/" className='flex gap-2' onClick={handleClick}><span className='text-sm'>HOME</span></NavLink></nav></li>
        <li className='my-3 py-3 hover:bg-[#ffffff14] hover:rounded item-center text-lg'><nav><NavLink to="" className='flex gap-2' onClick={handleClick}><span className='text-sm'> ABOUT</span></NavLink></nav></li>
        <li className='my-3 py-3 hover:bg-[#ffffff14] hover:rounded item-center text-lg'><nav><NavLink to="" className='flex gap-2' onClick={handleClick}><span className='text-sm'> CONTACT US</span></NavLink></nav></li>
      </ul>
    </div>
  </>
