...
function PricingCard() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 max-lg:px-5 px-28 gap-20 place-items-center relative -top-60">
            <div className='block text-left max-w-[500px] max-h-[550px] bg-gradient-to-b from-[#B6BAFF33] to-[#232ED133] rounded-xl p-10'>
                <h1 className='font-bold text-black text-2xl my-2'>Launch</h1>
                <p className='text-2xl font-bold my-2'>$<span className='text-5xl font-bold text-black my-4'>19</span>/mo</p>
                <p className='text-gray-500 font-semibold my-2'>Integer proin ac, lectus proin egestas ultricies. </p>
                <ul className='font-semibold list-image-icon mx-7'>
            ...
            <div className='block text-left max-w-[500px] max-h-[550px] bg-gradient-to-b from-[#fce7e333] to-[#ad3d2433] rounded-xl p-10'>
                <h1 className='font-bold text-black text-2xl my-2'>Launch</h1>
                <p className='text-2xl font-bold my-2'>$<span className='text-5xl font-bold text-black my-4'>49</span>/mo</p>
                <p className='text-gray-500 font-semibold my-2'>Integer proin ac, lectus proin egestas ultricies. </p>
                <ul className='font-semibold list-image-icons mx-7'>
            ...
            <div className='block text-left max-w-[500px] max-h-[550px] bg-gradient-to-b from-[#c0c3ff33] to-[#343eca33] rounded-xl p-10'>
                <h1 className='font-bold text-black text-2xl my-2'>Launch</h1>
                <p className='text-2xl font-bold my-2'>$<span className='text-5xl font-bold text-black my-4'>79</span>/mo</p>
                <p className='text-gray-500 font-semibold my-2'>Integer proin ac, lectus proin egestas ultricies. </p>
                <ul className='font-semibold list-image-icon mx-7'>
