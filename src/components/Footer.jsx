        ...
        <div className='max-w-4xl pb-10 mx-auto'>
          ...
          <div className='flex max-sm:flex-col gap-10 justify-between items-center mx-auto py-4'>
            ...
            <form className='left-0 flex items-center'>
              <div>
                <input type="email" placeholder='Enter email' className='relative text-left w-60 h-[3.25rem] max-sm:w-40 max-sm:h-[2.75rem] p-2 text-black font-semibold outline-none rounded-l left-1' />
              </div>
