...
function HomeHero() {
    return (
        <div className='py-14 px-16 max-md:px-5 bg-gradient-to-b from-[#B6BAFF33] to-[#232ED133]'>
            <div className='md:flex gap-20 items-center text-center md:justify-between'>
